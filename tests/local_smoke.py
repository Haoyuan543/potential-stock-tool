...
def main() -> None:
    ...
    for marker in [
        ...
        "storageStatus",
        "納入前一晚美股科技 / 半導體領先因子",
        "potential-20260608-postmarket-review-v1",
    ]:
    ...
    for marker in [
        'APP_VERSION = "potential-20260608-postmarket-review-v1"',
        "decisionReviewTable",
        "decisionChangeLabel",
        "readApiError",
        "502 Bad Gateway",
    ...
    assert health.json()["backend_version"] == "potential-20260608-postmarket-review-v1"
